...
class pyRat:
    ...
    def run(self):
        ...
        try: 
            ...
            print('Sorry but I cannot parse \'' + input_.strip() + '\'. (But you can improve me!)')
    ...
    def displayHelp(self):
        ...
        print(line)
        print('In version ' + self.version + ', pyRat can simplify fractions but also compute')
        print('sums and products of fractions!\n')
        print('Well... that\'s not bad but you can really improve pyRat')
        print('(see \"Exercices supplementaires\" for improvement\'s suggestions)')
        print(line)
